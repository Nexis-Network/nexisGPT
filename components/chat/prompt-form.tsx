...
export const PromptForm = ({ append, status }: PromptProps) => {
  ...
  return (
    <>
      ...
      <div className="mt-4 text-center text-xs text-gray-400 px-1">
        <p>Your NexisGPT chats aren't used to train our models. NexisGPT may display inaccurate info, so double-check its responses and always get a code audit done.</p>
      </div>
    </>
  )
}
