...
import { IconUser, IconNexisGPT } from "@/components/ui/icons"
...
export function ChatMessage({ message, avatarUrl, status }: ChatMessageProps) {
  return (
    <div className="group bg-[#272727]/40 border border-[#272727] backdrop-blur-xs rounded-xl pt-2 pb-2 pl-2 relative flex w-full mb-4 items-start md:-ml-12">
